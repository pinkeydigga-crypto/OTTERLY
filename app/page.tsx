  ...
  return (
    ...
    >
      ...
      <style jsx global>{`
        ...
        /* Custom speech bubble tail pointing directly to mascot's hand */
        .otto-bubble-tail {
          position: absolute;
          bottom: -7px;
          right: 12px;
      ...
      {/* Main Hero Section */}
      <main className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-6 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center my-auto z-10 pb-12">
        ...
        <div className="lg:col-span-5 relative pt-12 w-full max-w-md mx-auto lg:max-w-none">
          ...
          {/* Mascot Image (Explicit Dimensions for Lazy Loading / LCP) */}
