  ...
  return (
    <div className="min-h-screen bg-[#F6FAFF] flex flex-col md:flex-row tracking-tight pb-20 md:pb-0 font-sans">
      ...
      <main className="flex-1 p-4 sm:p-8 max-w-7xl mx-auto space-y-6 overflow-y-auto w-full">
        ...
        {/* AI Scan Card */}
        <div className="bg-[#2563EB] text-white p-6 sm:p-8 rounded-[2rem] shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-3 max-w-lg z-10">
            <span className="inline-block bg-white/20 text-white text-[11px] font-black px-3 py-1 rounded-full uppercase tracking-wider">
              AI Drawing Assistant
            </span>
            <h2 className="text-xl sm:text-3xl font-black leading-tight">
              Scan & Analyze Your Artwork
            </h2>
            <p className="text-xs sm:text-sm font-bold text-blue-100 leading-relaxed">
              Upload your drawing to get instant AI-powered feedback, score, and tips to improve!
            </p>
            <div className="pt-1">
              <Link
                href="/scan"
                className="inline-flex items-center gap-2 bg-white text-[#2563EB] px-5 py-2.5 rounded-xl font-black text-xs uppercase tracking-wider border-2 border-slate-200 border-b-4 border-b-slate-300 hover:bg-slate-50 active:border-b-2 active:translate-y-[2px] transition-all shadow-sm"
              >
                Start Scanning <ChevronRight className="w-3.5 h-3.5 stroke-[3]" />
              </Link>
            </div>
          </div>

          <div className="w-20 h-20 sm:w-28 sm:h-28 bg-white/10 rounded-2xl flex items-center justify-center border-2 border-white/20 shrink-0 z-10">
            <Scan className="w-10 h-10 sm:w-14 sm:h-14 text-white" />
          </div>
        </div>
